...
/*   Updated: 2026/06/29 10:08:36 by username         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_main(t_u64a argc, t_u8 **argv, t_u8 **envp)
{
	...
	{ft_memset_test_stream_1x_unaligned, (t_blk8r)"memset_stream_1x_unaligned"},
	{ft_memset_test_stream_2x_unaligned, (t_blk8r)"memset_stream_2x_unaligned"},
	{ft_memset_test_stream_1x_aligned, (t_blk8r)"memset_stream_1x_aligned"},
	{ft_memset_test_stream_2x_aligned, (t_blk8r)"memset_stream_2x_aligned"},
	};
	t_tailor				t;
